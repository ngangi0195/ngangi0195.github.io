...
export const projects: Project[] = [
  {
    ...
    description:
      'An off-campus apartment finder enabling transparent, data-driven housing decisions by scraping real-time pricing from **18 apartments**, attracting **11,000+ visits**.',
    longDescription:
  ...
  },
  {
    ...
    github: 'https://github.com/ngangi0195',
    demo: 'https://drive.google.com/file/d/1cHwYDDsE4WmueMSOVKTIHE8xEPk0suAE/view?usp=sharing',
    status: 'complete',
  },
  {
    id: 'itps-research',
  ...
  },
  {
    ...
    github: 'https://github.com/RishiAc/XITM_RPF_Analyzer',
    status: 'complete',
  },
  {
    id: 'craving-hour',
    ...
    description:
      'Full-stack platform on **AWS** (React, Node.js, PostgreSQL, RDS, Lambda, CloudFront) — **43% operational efficiency gain** across **150+ daily customers**.',
