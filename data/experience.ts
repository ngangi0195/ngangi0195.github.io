...
export const experience: ExperienceEntry[] = [
  {
    ...
    endDate: 'Present',
    bullets: [
      'Porting **ITPS** (MIT CSAIL) to a **UR3** robotic arm in **MuJoCo** — validating human-guided trajectory steering across all **4 steering methods** on **CPU + CUDA** without retraining.',
    ],
