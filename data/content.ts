...
export const contentItems: ContentItem[] = [
  // --- What I'm Into ---
  {
    ...
    note: 'Although I have explored Rust in class, I want to get a thorough understanding this increasingly popular language. I feel it forces you to think about memory makes you a sharper programmer in any language.',
    category: 'book',
    emoji: '📘',
  ...
  },
  {
    ...
    note: 'My start to exploring fundamental concepts in modern robotics. The self-attention mechanism is highly efficient — and more applicable to robotics than I expected.',
    category: 'paper',
    emoji: '📄',
  ...
  },
  {
    ...
    creator: 'Sadhguru',
    note: 'I practice meditation, and Sadhguru has a way of articulating things that actually land. His insights have a beautiful staying power — the kind that surface at the right moments throughout my days.',
    category: 'podcast',
    emoji: '🎙️',
  ...
  },
  {
    ...
    creator: 'MKBHD',
    note: 'From cars to consumer electronics, MKBHD brings a considered (and popular) perspective as to what\'s happening in tech. Less about specs, more about what products actually mean.',
    category: 'youtube',
    emoji: '▶️',
  ...
  },
  {
    ...
    note: 'My soundtrack to focused work. His music has an effortless warmth that makes long sessions feel lighter, and I hope to see him in concert soon (fingers crossed)!',
    category: 'music',
    emoji: '🎵',
